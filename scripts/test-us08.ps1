...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us08-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US08SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US08SmokeTest failed."
    }
} finally {
