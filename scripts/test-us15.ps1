...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us15-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US15SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US15SmokeTest failed."
    }
} finally {
