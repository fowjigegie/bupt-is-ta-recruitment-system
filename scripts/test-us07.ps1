...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us07-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US07SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US07SmokeTest failed."
    }
} finally {
