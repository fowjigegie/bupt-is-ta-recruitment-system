...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us06-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US06SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US06SmokeTest failed."
    }
} finally {
