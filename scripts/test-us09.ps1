...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us09-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US09SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US09SmokeTest failed."
    }
} finally {
