...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us01-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US01SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US01SmokeTest failed."
    }
} finally {
