...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us10-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US10SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US10SmokeTest failed."
    }
} finally {
