...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us05-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US05SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US05SmokeTest failed."
    }
} finally {
