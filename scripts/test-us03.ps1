...
$tempWorkspace = New-TempWorkspace -Prefix "ta-us03-test"
...
try {
    ...
    & $java -cp "$stagedMainOutputDir;$stagedTestOutputDir" com.bupt.tarecruitment.US03SmokeTest
    if ($LASTEXITCODE -ne 0) {
        throw "US03SmokeTest failed."
    }
} finally {
